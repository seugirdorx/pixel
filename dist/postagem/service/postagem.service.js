...
let PostagemService = class PostagemService {
    ...
    async findById(id) {
        ...
        if (!postagem)
            throw new exceptions_1.HttpException('Postagem não existe', enums_1.HttpStatus.NOT_FOUND);
        return postagem;
    }
    ...
    async delete(id) {
        ...
        if (!buscarPostagem)
            throw new exceptions_1.HttpException('Postagem não encontrada', enums_1.HttpStatus.NOT_FOUND);
